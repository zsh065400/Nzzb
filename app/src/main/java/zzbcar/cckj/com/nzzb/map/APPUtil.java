...
public class AppUtil {
  ...
  public static void startNative_Baidu(Context context,Location loc1,Location loc2){
    ...
    try {
      Intent intent = Intent.getIntent("baidumap://map/direction?origin=latlng:"+loc1.getStringLatLng()+"|name:"+loc1.getAddress()+"&destination=latlng:"+loc2.getStringLatLng()+"|name:"+loc2.getAddress()+"&mode=walking");
  ...
  public static void startNative_Gaode(Context context,Location loc){
    ...
    try {
          ...
          Uri.parse("amapuri://route/plan/?dlat="+loc.getLat()+"&dlon="+loc.getLng()+"&dname="+loc.getAddress()+"&dev=0&t=2"));
